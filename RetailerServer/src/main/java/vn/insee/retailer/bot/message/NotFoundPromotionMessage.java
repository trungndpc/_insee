...
public class NotFoundPromotionMessage extends Message {
    private static final Logger LOGGER = LogManager.getLogger(NotFoundPromotionMessage.class);

    public NotFoundPromotionMessage(User user) {
        super(user);
    }
